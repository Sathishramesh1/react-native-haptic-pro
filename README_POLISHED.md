...
This README is written to help new users get started quickly, understand the public API, run the example app, and contribute.
...
Add badges for npm, license, and CI at the top of this README. Example badge services: shields.io and GitHub Actions.
